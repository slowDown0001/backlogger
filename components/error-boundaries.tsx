...
export function BoardWrapper({ tilesWithTasks, currentUserId, workspaceId }: DragDropWrapperProps) {
  return (
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <DragDropWrapper tilesWithTasks={tilesWithTasks} currentUserId={currentUserId} workspaceId={workspaceId} />
    </ErrorBoundary>
  );
}
// "use client";
